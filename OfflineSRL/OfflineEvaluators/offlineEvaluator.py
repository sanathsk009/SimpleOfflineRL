...
class StandardPesEval(offlineTabularBaseEvaluator):
    ...
    def __init__(self, name, states, actions, epLen, evalpolicy, bpolicy, is_eval = True, is_finite = False, evaluation_step = 0):
    ...
    def _extract_bpolicy(self):
        ...
        self.agent._update_bpolicy(bpolicy, self.evaluation_step)
...
class SPVIEval(offlineTabularBaseEvaluator):
    ...
    def __init__(self, name, states, actions, epLen, evalpolicy, bpolicy, data_splitting, delta, nTrajectories, epsilon1, epsilon2, epsilon3, scaling=1., max_step_reward = 1, min_step_reward = 0, abs_max_ep_reward = 1, is_eval = True, is_finite = False):
        '''
        As per the tabular learner, but added tunable scaling.
